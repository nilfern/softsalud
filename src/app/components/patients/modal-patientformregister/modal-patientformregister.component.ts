...
@Component({
  ...
  templateUrl: './modal-patientformregister.component.html',
  styleUrl: './modal-patientformregister.component.css',
})
export class ModalPatientformregisterComponent implements OnInit {
  fileName: string = '';
  findpatient!: String;
  ...
  onSubmit() {
    if (this.patientForm.valid) {
      ...
      formData.append('address', 'sin dato');
      ...
      formData.append('occupation', 'sin dato');
      ...
      this.patientService.register(formData).subscribe((res) => {
